...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const loginStep1 = document.getElementById('login-step-1') as HTMLDivElement;
    const loginStep2 = document.getElementById('login-step-2') as HTMLDivElement;
    ...
    // Prayer, Chat, Live, News, Bible... (rest of selectors are the same)
    ...
    function showContent(targetId: string) {
        ...
        else if (videoPlayer && videoPlayer.src) videoPlayer.src = '';
        if (targetId === 'bible') setupBiblePage();
    }

    function initializeForChurch() {
        if (!currentChurchId || !churchData) return;
        prayerList.innerHTML = ''; sermonListEl.innerHTML = ''; newsList.innerHTML = ''; chatListContainer.innerHTML = '';
